...
SECRET_KEY = 'django-insecure-^rjyunywcnq6p!=z6+dv&wei3v47vf5)_d_fv4evktmxvb&x1p'
...
CELERY_BEAT_SCHEDULE = {
    'generate-random-number-every-5-seconds': {
        'task': 'random_number_app.websocket_app.tasks.generate_random_number',
